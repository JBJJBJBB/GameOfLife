...
namespace GameOfLife
{
    public partial class Form1 : Form
    {
        ...
        {
            for (int y = 0; y < CellsY; y++) //Draw all cells from Cells array
            {
        ...
        {
            if (Form.ModifierKeys == Keys.None && keyData == Keys.F2) //Start/Stop
            {
            ...
            if (Form.ModifierKeys == Keys.None && keyData == Keys.Escape) //Exit
            {
                Application.Exit();
                return true;
            }
