...
namespace GameOfLife
{
    ...
    public partial class FrameTable
    {
        ...
        //Create 
        public void SaveGame(FrameTable g)
        {
        ...
        public string LoadGame(FrameTable g)
        {
            using (Connection connection = new Connection())
            {
                FrameTable st = new FrameTable();
                var objecttoLoad = g as FrameTable;
        ...
        public void EditSave(FrameTable g)
        {

            using (Connection connection = new Connection())
            {
                var objecttoedit = g as FrameTable;
        ...
        public void DeleteSave(FrameTable g)
        {
            using (Connection connection = new Connection())
            {
                int remID =  g.Id;
                var gametoremove = connection.FrameTables.Find(remID);
                connection.FrameTables.Remove(gametoremove);
                connection.SaveChanges();
            }
